...
public class StepDefinition extends Reusable{
    ...
    public void status_in_response_body_is_something(String strArg1, String strArg2) throws Throwable {
    	...
    	employeeName = js.getString("data.name").toString();
    ...
    public void verify_employee_data_is_added_using(String ExpectedName, String resource) throws IOException {
    	
    	reqSpecifications().queryParam("id", id);
    	user_calls_with_Http_Request(resource, "GET");

    	assertEquals(employeeName, ExpectedName);
    	System.out.println("Employee details of '"+employeeName+"' was successfully updated");
    }
